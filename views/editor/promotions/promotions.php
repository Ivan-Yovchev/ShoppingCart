    ...
    <?php foreach($this->promotions as $promotion): ?>
        <li>
            ...
            <div id="promotion-actions">
                <a href="/cart/editor/promotions/onproduct/<?= $promotion['id'] ?>">
                    On Product
                </a>
                <a href="/cart/editor/promotions/oncategory/<?= $promotion['id'] ?>">
                    On Category
                </a>
                <a href="/cart/editor/promotions/onall/<?= $promotion['id'] ?>">
                    On All
                </a>
            </div>
        </li>
